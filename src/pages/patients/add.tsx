	...
	return (
		<main className="flex flex-col min-h-[85vh]">
			...
			<div className="mt-5 flex flex-col h-full w-full justify-center items-center">
				<div className="mt-8 w-[80%] min-h-72 bg-slate-800 rounded-lg ring-2 ring-slate-200">
			...
			<div className="my-10 py-5 px-10 flex justify-center items-center rounded-lg bg-rose-500 text-3xl font-semibold text-slate-800 ring-2 ring-slate-200 cursor-pointer" onClick={addPatient}>Add Patient</div>
			</div>
		</main>
	)
}